...
public class IMG2Sprite : MonoBehaviour {
	...
	public Sprite LoadNewSprite(string FilePath, float PixelsPerUnit = 100.0f) {
		...
		if (SpriteTexture == null) {
			string placeholderPath = Application.dataPath + "/PikkartAR/Assets/Images/placeholder.jpg";
//			Debug.Log (placeholderPath);
			SpriteTexture = LoadTexture (placeholderPath);
		}
